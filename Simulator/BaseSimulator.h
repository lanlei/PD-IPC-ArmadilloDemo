...
class DecorativeModelPool :public BaseSurfaceMeshBufferPool, public BaseTetMeshBufferPool, public BaseMedialMeshBufferPool
{
public:
	DecorativeModelPool() {}
};
...
public:
	...
	virtual bool addDecorativeModelFromFile(std::vector<std::string> files, BaseModel* m);
	virtual bool addDecorativeModelFromConfigFile(const std::string filename, TiXmlElement* item);
	virtual bool addDecorativeModelFromConfigFile(const std::string filename, TiXmlElement* item, BaseModel* model);
	...
	std::vector<BaseModel*> decorativeModels;
...
protected:
	...
	DecorativeModelPool decorativeModelPool;
