...
{
    if constexpr (dim == 2) {
        internal::g_PE2D(p[0], p[1], e0[0], e0[1], e1[0], e1[1], grad.data());
    }
    else {
        internal::g_PE3D(p[0], p[1], p[2],
            e0[0], e0[1], e0[2],
            e1[0], e1[1], e1[2],
            grad.data());
    }
...
{
    if constexpr (dim == 2) {
        internal::H_PE2D(p[0], p[1], e0[0], e0[1], e1[0], e1[1], hess.data());
    }
    else {
        internal::H_PE3D(p[0], p[1], p[2],
            e0[0], e0[1], e0[2],
            e1[0], e1[1], e1[2],
            hess.data());
    }
...
template float point_edge_distance(const Vector<float, 2>&, const Vector<float, 2>& e0, const Vector<float, 2>& e1);
template void point_edge_distance_gradient(const Vector<float, 2>& p, const Vector<float, 2>& e0, const Vector<float, 2>& e1, Vector<float, 6>& grad);
template void point_edge_distance_hessian(const Vector<float, 2>& p, const Vector<float, 2>& e0, const Vector<float, 2>& e1, Matrix<float, 6, 6>& hess);
#endif
#ifdef BOW_COMPILE_3D
template float point_edge_distance(const Vector<float, 3>&, const Vector<float, 3>& e0, const Vector<float, 3>& e1);
template void point_edge_distance_gradient(const Vector<float, 3>& p, const Vector<float, 3>& e0, const Vector<float, 3>& e1, Vector<float, 9>& grad);
template void point_edge_distance_hessian(const Vector<float, 3>& p, const Vector<float, 3>& e0, const Vector<float, 3>& e1, Matrix<float, 9, 9>& hess);
#endif
#endif
#ifdef BOW_COMPILE_DOUBLE
#ifdef BOW_COMPILE_2D
template double point_edge_distance(const Vector<double, 2>&, const Vector<double, 2>& e0, const Vector<double, 2>& e1);
template void point_edge_distance_gradient(const Vector<double, 2>& p, const Vector<double, 2>& e0, const Vector<double, 2>& e1, Vector<double, 6>& grad);
template void point_edge_distance_hessian(const Vector<double, 2>& p, const Vector<double, 2>& e0, const Vector<double, 2>& e1, Matrix<double, 6, 6>& hess);
#endif
#ifdef BOW_COMPILE_3D
template double point_edge_distance(const Vector<double, 3>&, const Vector<double, 3>& e0, const Vector<double, 3>& e1);
template void point_edge_distance_gradient(const Vector<double, 3>& p, const Vector<double, 3>& e0, const Vector<double, 3>& e1, Vector<double, 9>& grad);
template void point_edge_distance_hessian(const Vector<double, 3>& p, const Vector<double, 3>& e0, const Vector<double, 3>& e1, Matrix<double, 9, 9>& hess);
#endif
#endif
#endif
