...
namespace internal {
template <class T>
inline void g_EE(T v01, T v02, T v03, T v11, T v12, T v13,
...
{
    internal::g_EECN2(ea0[0], ea0[1], ea0[2],
        ea1[0], ea1[1], ea1[2],
        eb0[0], eb0[1], eb0[2],
        eb1[0], eb1[1], eb1[2],
        grad.data());
...
{
    return 1.0e-3 * (ea0_rest - ea1_rest).squaredNorm() * (eb0_rest - eb1_rest).squaredNorm();
}
...
{
    T EECrossSqNorm = edge_edge_cross_norm2(ea0, ea1, eb0, eb1);
    if (EECrossSqNorm < eps_x)
        return internal::EEM(EECrossSqNorm, eps_x);
    else
        return 1.0;
}
...
BOW_INLINE void edge_edge_mollifier_gradient(const Vector<T, 3>& ea0, const Vector<T, 3>& ea1, const Vector<T, 3>& eb0, const Vector<T, 3>& eb1, const T eps_x, Vector<T, 12>& grad)
{
    T EECrossSqNorm = edge_edge_cross_norm2(ea0, ea1, eb0, eb1);
    if (EECrossSqNorm < eps_x) {
        T q_g = internal::g_EEM(EECrossSqNorm, eps_x);
        edge_edge_cross_norm2_gradient(ea0, ea1, eb0, eb1, grad);
        grad *= q_g;
    }
    else {
        grad.setZero();
...
template <class T>
BOW_INLINE void edge_edge_mollifier_hessian(const Vector<T, 3>& ea0, const Vector<T, 3>& ea1, const Vector<T, 3>& eb0, const Vector<T, 3>& eb1, const T eps_x, Matrix<T, 12, 12>& H)
{
    T EECrossSqNorm = edge_edge_cross_norm2(ea0, ea1, eb0, eb1);
    if (EECrossSqNorm < eps_x) {
        T q_g = internal::g_EEM(EECrossSqNorm, eps_x);
        T q_H = internal::H_EEM(EECrossSqNorm, eps_x);
...
{
    internal::g_EE(ea0[0], ea0[1], ea0[2],
        ea1[0], ea1[1], ea1[2],
        eb0[0], eb0[1], eb0[2],
        eb1[0], eb1[1], eb1[2],
        grad.data());
...
{
    internal::H_EE(ea0[0], ea0[1], ea0[2],
        ea1[0], ea1[1], ea1[2],
        eb0[0], eb0[1], eb0[2],
        eb1[0], eb1[1], eb1[2],
        hessian.data());
...
template float edge_edge_cross_norm2(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1);
template void edge_edge_cross_norm2_gradient(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, Vector<float, 12>& grad);
template void edge_edge_cross_norm2_hessian(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, Matrix<float, 12, 12>& hessian);
template float edge_edge_mollifier_threshold(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1);
template float edge_edge_mollifier(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, const float eps_x);
template void edge_edge_mollifier_gradient(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, const float eps_x, Vector<float, 12>& grad);
template void edge_edge_mollifier_hessian(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, const float eps_x, Matrix<float, 12, 12>& hessian);
template float edge_edge_distance(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1);
template void edge_edge_distance_gradient(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, Vector<float, 12>& grad);
template void edge_edge_distance_hessian(const Vector<float, 3>& ea0, const Vector<float, 3>& ea1, const Vector<float, 3>& eb0, const Vector<float, 3>& eb1, Matrix<float, 12, 12>& hessian);
#endif
#endif
#ifdef BOW_COMPILE_DOUBLE
#ifdef BOW_COMPILE_3D
template double edge_edge_cross_norm2(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1);
template void edge_edge_cross_norm2_gradient(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, Vector<double, 12>& grad);
template void edge_edge_cross_norm2_hessian(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, Matrix<double, 12, 12>& hessian);
template double edge_edge_mollifier_threshold(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1);
template double edge_edge_mollifier(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, const double eps_x);
template void edge_edge_mollifier_gradient(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, const double eps_x, Vector<double, 12>& grad);
template void edge_edge_mollifier_hessian(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, const double eps_x, Matrix<double, 12, 12>& hessian);
template double edge_edge_distance(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1);
template void edge_edge_distance_gradient(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, Vector<double, 12>& grad);
template void edge_edge_distance_hessian(const Vector<double, 3>& ea0, const Vector<double, 3>& ea1, const Vector<double, 3>& eb0, const Vector<double, 3>& eb1, Matrix<double, 12, 12>& hessian);
#endif
#endif
#endif
