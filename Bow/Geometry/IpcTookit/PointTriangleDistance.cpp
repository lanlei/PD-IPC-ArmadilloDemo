...
namespace internal {
template <class T>
void g_PT(T v01, T v02, T v03, T v11, T v12, T v13,
...
template float point_triangle_distance(const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&);
template void point_triangle_distance_gradient(const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&, Vector<float, 12>&);
template void point_triangle_distance_hessian(const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&, const Vector<float, 3>&, Matrix<float, 12, 12>&);
#endif
#endif
#ifdef BOW_COMPILE_DOUBLE
#ifdef BOW_COMPILE_3D
template double point_triangle_distance(const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&);
template void point_triangle_distance_gradient(const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&, Vector<double, 12>&);
template void point_triangle_distance_hessian(const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&, const Vector<double, 3>&, Matrix<double, 12, 12>&);
#endif
#endif
#endif
