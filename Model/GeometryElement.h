...
public:
	...
	void show()
	{
		...
		for (int i = 0; i < 12; i++)
		{
			int vid0 = indices[3 * i + 0];
			int vid1 = indices[3 * i + 1];
			int vid2 = indices[3 * i + 2];
			QVector3D v0(points.data()[3 * vid0], points.data()[3 * vid0 + 1], points.data()[3 * vid0 + 2]);
			QVector3D v1(points.data()[3 * vid1], points.data()[3 * vid1 + 1], points.data()[3 * vid1 + 2]);
			QVector3D v2(points.data()[3 * vid2], points.data()[3 * vid2 + 1], points.data()[3 * vid2 + 2]);
...
public:
	...
	void setTranslation(qeal x, qeal y, qeal z);
