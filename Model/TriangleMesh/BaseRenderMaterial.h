...
public:
	...
	bool readTextureMap(const QString filename, int mapIndex = AmbientMapIndex);
	bool readCubeTextureMap(std::vector<QString>& filename, int mapIndex = AmbientMapIndex);
